...
**First run: Jev 1.13.0 scores 47.8% (32/67) on the module-keyed items — 75% on PU's verbal half, 30% on its arithmetic half. Full numbers in [RESULTS.md](RESULTS.md).**
